...
global.sudo = process.env.SUDO || "2349034419191";
global.owner = process.env.OWNER_NUMBER || "2349034419191";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "*Powered By 𝐹𝑅𝐴𝑌𝑂  𝑉𝑋*",
  author: process.env.PACK_AUTHER || "𝐹𝑅𝐴𝑌𝑂  𝑉𝑋",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "FRAYO-VX",
  ownername: process.env.OWNER_NAME || "𝐹𝑅𝐴𝑌𝑂  𝑉𝑋",
